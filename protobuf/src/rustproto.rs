...
pub mod exts {
    ...
    pub const oneof_field_box_all: crate::ext::ExtFieldOptional<crate::descriptor::FileOptions, crate::reflect::types::ProtobufTypeBool> = crate::ext::ExtFieldOptional { field_number: 17036, phantom: ::std::marker::PhantomData };
    ...
    pub const oneof_field_box: crate::ext::ExtFieldOptional<crate::descriptor::MessageOptions, crate::reflect::types::ProtobufTypeBool> = crate::ext::ExtFieldOptional { field_number: 17036, phantom: ::std::marker::PhantomData };
    ...
    pub const oneof_field_box_field: crate::ext::ExtFieldOptional<crate::descriptor::FieldOptions, crate::reflect::types::ProtobufTypeBool> = crate::ext::ExtFieldOptional { field_number: 17036, phantom: ::std::marker::PhantomData };
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    eAll:M\n\x13oneof_field_box_all\x18\x8c\x85\x01\x20\x01(\x08\x12\x1c.goo\
    gle.protobuf.FileOptionsR\x10oneofFieldBoxAll:D\n\x0cexpose_oneof\x18\
    ...
    erateAccessors:J\n\x0fgenerate_getter\x18\xed\x84\x01\x20\x01(\x08\x12\
    \x1f.google.protobuf.MessageOptionsR\x0egenerateGetter:^\n\x1acarllerche\
    _bytes_for_bytes\x18\xf3\x84\x01\x20\x01(\x08\x12\x1f.google.protobuf.Me\
    ssageOptionsR\x17carllercheBytesForBytes:`\n\x1bcarllerche_bytes_for_str\
    ing\x18\xf4\x84\x01\x20\x01(\x08\x12\x1f.google.protobuf.MessageOptionsR\
    \x18carllercheBytesForString:O\n\x12repeated_field_vec\x18\xfc\x84\x01\
    \x20\x01(\x08\x12\x1f.google.protobuf.MessageOptionsR\x10repeatedFieldVe\
    c:\\\n\x19singular_field_option_box\x18\x80\x85\x01\x20\x01(\x08\x12\x1f\
    .google.protobuf.MessageOptionsR\x16singularFieldOptionBox:U\n\x15singul\
    ar_field_option\x18\x81\x85\x01\x20\x01(\x08\x12\x1f.google.protobuf.Mes\
    sageOptionsR\x13singularFieldOption:D\n\x0cserde_derive\x18\x86\x85\x01\
    ...
    MessageOptionsR\x0eserdeDeriveCfg:I\n\x0foneof_field_box\x18\x8c\x85\x01\
    \x20\x01(\x08\x12\x1f.google.protobuf.MessageOptionsR\roneofFieldBox:O\n\
    ...
    larFieldOptionField:R\n\x15oneof_field_box_field\x18\x8c\x85\x01\x20\x01\
    (\x08\x12\x1d.google.protobuf.FieldOptionsR\x12oneofFieldBoxFieldJ\xbc'\
    ...
    \n\n\n\x03\x07\x0b\x03\x12\x03'%*\nz\n\x02\x07\x0c\x12\x03+\x04.\x1ao\
    \x20Use\x20`std::Box<T>`\x20to\x20store\x20oneof\x20message\x20fields.\n\
    \x20This\x20is\x20useful\x20for\x20mutually\x20recursive\x20messages\x20\
    with\x20oneofs.\n\n\n\n\x03\x07\x0c\x02\x12\x03\x0c\x07\"\n\n\n\x03\x07\
    \x0c\x04\x12\x03+\x04\x0c\n\n\n\x03\x07\x0c\x05\x12\x03+\r\x11\n\n\n\x03\
    \x07\x0c\x01\x12\x03+\x12%\n\n\n\x03\x07\x0c\x03\x12\x03+(-\n\t\n\x01\
    \x07\x12\x04.\0J\x01\n7\n\x02\x07\r\x12\x030\x04'\x1a,\x20When\x20true,\
    \x20oneof\x20field\x20is\x20generated\x20public\n\n\n\n\x03\x07\r\x02\
    \x12\x03.\x07%\n\n\n\x03\x07\r\x04\x12\x030\x04\x0c\n\n\n\x03\x07\r\x05\
    \x12\x030\r\x11\n\n\n\x03\x07\r\x01\x12\x030\x12\x1e\n\n\n\x03\x07\r\x03\
    \x12\x030!&\nI\n\x02\x07\x0e\x12\x032\x04(\x1a>\x20When\x20true\x20all\
    \x20fields\x20are\x20public,\x20and\x20not\x20accessors\x20generated\n\n\
    \n\n\x03\x07\x0e\x02\x12\x03.\x07%\n\n\n\x03\x07\x0e\x04\x12\x032\x04\
    \x0c\n\n\n\x03\x07\x0e\x05\x12\x032\r\x11\n\n\n\x03\x07\x0e\x01\x12\x032\
    \x12\x1f\n\n\n\x03\x07\x0e\x03\x12\x032\"'\nP\n\x02\x07\x0f\x12\x034\x04\
    ...
    \n\n\x03\x07\x0f\x04\x12\x034\x04\x0c\n\n\n\x03\x07\x0f\x05\x12\x034\r\
    \x11\n\n\n\x03\x07\x0f\x01\x12\x034\x12$\n\n\n\x03\x07\x0f\x03\x12\x034'\
    ,\nL\n\x02\x07\x10\x12\x036\x04*\x1aA\x20When\x20false,\x20`get_`\x20is\
    \x20not\x20generated\x20even\x20if\x20`syntax\x20=\x20\"proto2\"`\n\n\n\
    \n\x03\x07\x10\x02\x12\x03.\x07%\n\n\n\x03\x07\x10\x04\x12\x036\x04\x0c\
    \n\n\n\x03\x07\x10\x05\x12\x036\r\x11\n\n\n\x03\x07\x10\x01\x12\x036\x12\
    !\n\n\n\x03\x07\x10\x03\x12\x036$)\n2\n\x02\x07\x11\x12\x038\x045\x1a'\
    \x20Use\x20`bytes::Bytes`\x20for\x20`bytes`\x20fields\n\n\n\n\x03\x07\
    \x11\x02\x12\x03.\x07%\n\n\n\x03\x07\x11\x04\x12\x038\x04\x0c\n\n\n\x03\
    \x07\x11\x05\x12\x038\r\x11\n\n\n\x03\x07\x11\x01\x12\x038\x12,\n\n\n\
    \x03\x07\x11\x03\x12\x038/4\n3\n\x02\x07\x12\x12\x03:\x046\x1a(\x20Use\
    \x20`bytes::Bytes`\x20for\x20`string`\x20fields\n\n\n\n\x03\x07\x12\x02\
    \x12\x03.\x07%\n\n\n\x03\x07\x12\x04\x12\x03:\x04\x0c\n\n\n\x03\x07\x12\
    \x05\x12\x03:\r\x11\n\n\n\x03\x07\x12\x01\x12\x03:\x12-\n\n\n\x03\x07\
    \x12\x03\x12\x03:05\n<\n\x02\x07\x13\x12\x03<\x04-\x1a1\x20Use\x20`std::\
    Vec`\x20to\x20store\x20repeated\x20messages\x20field\n\n\n\n\x03\x07\x13\
    \x02\x12\x03.\x07%\n\n\n\x03\x07\x13\x04\x12\x03<\x04\x0c\n\n\n\x03\x07\
    \x13\x05\x12\x03<\r\x11\n\n\n\x03\x07\x13\x01\x12\x03<\x12$\n\n\n\x03\
    \x07\x13\x03\x12\x03<',\nM\n\x02\x07\x14\x12\x03>\x044\x1aB\x20Use\x20`s\
    ...
    \x03A\x040\x1a\x87\x01\x20Use\x20`std::Option<T>`\x20to\x20store\x20sing\
    ...
    \n\n\n\n\x03\x07\x15\x02\x12\x03.\x07%\n\n\n\x03\x07\x15\x04\x12\x03A\
    \x04\x0c\n\n\n\x03\x07\x15\x05\x12\x03A\r\x11\n\n\n\x03\x07\x15\x01\x12\
    \x03A\x12'\n\n\n\x03\x07\x15\x03\x12\x03A*/\nJ\n\x02\x07\x16\x12\x03C\
    \x04'\x1a?\x20Use\x20`serde_derive`\x20to\x20implement\x20`Serialize`\
    \x20and\x20`Deserialize`\n\n\n\n\x03\x07\x16\x02\x12\x03.\x07%\n\n\n\x03\
    \x07\x16\x04\x12\x03C\x04\x0c\n\n\n\x03\x07\x16\x05\x12\x03C\r\x11\n\n\n\
    \x03\x07\x16\x01\x12\x03C\x12\x1e\n\n\n\x03\x07\x16\x03\x12\x03C!&\n3\n\
    \x02\x07\x17\x12\x03E\x04-\x1a(\x20Guard\x20serde\x20annotations\x20with\
    \x20cfg\x20attr.\n\n\n\n\x03\x07\x17\x02\x12\x03.\x07%\n\n\n\x03\x07\x17\
    \x04\x12\x03E\x04\x0c\n\n\n\x03\x07\x17\x05\x12\x03E\r\x13\n\n\n\x03\x07\
    \x17\x01\x12\x03E\x14$\n\n\n\x03\x07\x17\x03\x12\x03E',\nz\n\x02\x07\x18\
    \x12\x03I\x04*\x1ao\x20Use\x20`std::Box<T>`\x20to\x20store\x20oneof\x20m\
    essage\x20fields.\n\x20This\x20is\x20useful\x20for\x20mutually\x20recurs\
    ive\x20messages\x20with\x20oneofs.\n\n\n\n\x03\x07\x18\x02\x12\x03.\x07%\
    \n\n\n\x03\x07\x18\x04\x12\x03I\x04\x0c\n\n\n\x03\x07\x18\x05\x12\x03I\r\
    \x11\n\n\n\x03\x07\x18\x01\x12\x03I\x12!\n\n\n\x03\x07\x18\x03\x12\x03I$\
    )\n\t\n\x01\x07\x12\x04L\0b\x01\nI\n\x02\x07\x19\x12\x03N\x04.\x1a>\x20W\
    hen\x20true\x20all\x20fields\x20are\x20public,\x20and\x20not\x20accessor\
    s\x20generated\n\n\n\n\x03\x07\x19\x02\x12\x03L\x07#\n\n\n\x03\x07\x19\
    \x04\x12\x03N\x04\x0c\n\n\n\x03\x07\x19\x05\x12\x03N\r\x11\n\n\n\x03\x07\
    \x19\x01\x12\x03N\x12%\n\n\n\x03\x07\x19\x03\x12\x03N(-\nP\n\x02\x07\x1a\
    \x12\x03P\x043\x1aE\x20When\x20false,\x20`get_`,\x20`set_`,\x20`mut_`\
    \x20etc.\x20accessors\x20are\x20not\x20generated\n\n\n\n\x03\x07\x1a\x02\
    \x12\x03L\x07#\n\n\n\x03\x07\x1a\x04\x12\x03P\x04\x0c\n\n\n\x03\x07\x1a\
    \x05\x12\x03P\r\x11\n\n\n\x03\x07\x1a\x01\x12\x03P\x12*\n\n\n\x03\x07\
    \x1a\x03\x12\x03P-2\nL\n\x02\x07\x1b\x12\x03R\x040\x1aA\x20When\x20false\
    ,\x20`get_`\x20is\x20not\x20generated\x20even\x20if\x20`syntax\x20=\x20\
    \"proto2\"`\n\n\n\n\x03\x07\x1b\x02\x12\x03L\x07#\n\n\n\x03\x07\x1b\x04\
    \x12\x03R\x04\x0c\n\n\n\x03\x07\x1b\x05\x12\x03R\r\x11\n\n\n\x03\x07\x1b\
    \x01\x12\x03R\x12'\n\n\n\x03\x07\x1b\x03\x12\x03R*/\n2\n\x02\x07\x1c\x12\
    \x03T\x04;\x1a'\x20Use\x20`bytes::Bytes`\x20for\x20`bytes`\x20fields\n\n\
    \n\n\x03\x07\x1c\x02\x12\x03L\x07#\n\n\n\x03\x07\x1c\x04\x12\x03T\x04\
    \x0c\n\n\n\x03\x07\x1c\x05\x12\x03T\r\x11\n\n\n\x03\x07\x1c\x01\x12\x03T\
    \x122\n\n\n\x03\x07\x1c\x03\x12\x03T5:\n3\n\x02\x07\x1d\x12\x03V\x04<\
    \x1a(\x20Use\x20`bytes::Bytes`\x20for\x20`string`\x20fields\n\n\n\n\x03\
    \x07\x1d\x02\x12\x03L\x07#\n\n\n\x03\x07\x1d\x04\x12\x03V\x04\x0c\n\n\n\
    \x03\x07\x1d\x05\x12\x03V\r\x11\n\n\n\x03\x07\x1d\x01\x12\x03V\x123\n\n\
    \n\x03\x07\x1d\x03\x12\x03V6;\n<\n\x02\x07\x1e\x12\x03X\x043\x1a1\x20Use\
    \x20`std::Vec`\x20to\x20store\x20repeated\x20messages\x20field\n\n\n\n\
    \x03\x07\x1e\x02\x12\x03L\x07#\n\n\n\x03\x07\x1e\x04\x12\x03X\x04\x0c\n\
    \n\n\x03\x07\x1e\x05\x12\x03X\r\x11\n\n\n\x03\x07\x1e\x01\x12\x03X\x12*\
    \n\n\n\x03\x07\x1e\x03\x12\x03X-2\nM\n\x02\x07\x1f\x12\x03Z\x04:\x1aB\
    \x20Use\x20`std::Option<std::Box<T>>`\x20to\x20store\x20singular\x20mess\
    ages\x20fields\n\n\n\n\x03\x07\x1f\x02\x12\x03L\x07#\n\n\n\x03\x07\x1f\
    \x04\x12\x03Z\x04\x0c\n\n\n\x03\x07\x1f\x05\x12\x03Z\r\x11\n\n\n\x03\x07\
    \x1f\x01\x12\x03Z\x121\n\n\n\x03\x07\x1f\x03\x12\x03Z49\n\x93\x01\n\x02\
    \x07\x20\x12\x03]\x046\x1a\x87\x01\x20Use\x20`std::Option<T>`\x20to\x20s\
    ...
    \x20enabled.\n\n\n\n\x03\x07\x20\x02\x12\x03L\x07#\n\n\n\x03\x07\x20\x04\
    \x12\x03]\x04\x0c\n\n\n\x03\x07\x20\x05\x12\x03]\r\x11\n\n\n\x03\x07\x20\
    \x01\x12\x03]\x12-\n\n\n\x03\x07\x20\x03\x12\x03]05\nz\n\x02\x07!\x12\
    \x03a\x040\x1ao\x20Use\x20`std::Box<T>`\x20to\x20store\x20oneof\x20messa\
    ge\x20fields.\n\x20This\x20is\x20useful\x20for\x20mutually\x20recursive\
    \x20messages\x20with\x20oneofs.\n\n\n\n\x03\x07!\x02\x12\x03L\x07#\n\n\n\
    \x03\x07!\x04\x12\x03a\x04\x0c\n\n\n\x03\x07!\x05\x12\x03a\r\x11\n\n\n\
    \x03\x07!\x01\x12\x03a\x12'\n\n\n\x03\x07!\x03\x12\x03a*/\
";
