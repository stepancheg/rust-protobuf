...
pub struct FieldDescriptorProto {
    ...
    label: ::std::option::Option<::protobuf::ProtobufEnum<FieldDescriptorProto_Label>>,
    field_type: ::std::option::Option<::protobuf::ProtobufEnum<FieldDescriptorProto_Type>>,
...
impl FieldDescriptorProto {
    ...
    pub fn get_label(&self) -> ::protobuf::ProtobufEnum<FieldDescriptorProto_Label> {
        self.label.unwrap_or(::protobuf::ProtobufEnum::from_enum(FieldDescriptorProto_Label::LABEL_OPTIONAL))
    }
    ...
    // Param is passed by value, moved
    pub fn set_label(&mut self, v: ::protobuf::ProtobufEnum<FieldDescriptorProto_Label>) {
        self.label = ::std::option::Option::Some(v);
    }

    // optional .google.protobuf.FieldDescriptorProto.Type type = 5;

    pub fn get_field_type(&self) -> ::protobuf::ProtobufEnum<FieldDescriptorProto_Type> {
        self.field_type.unwrap_or(::protobuf::ProtobufEnum::from_enum(FieldDescriptorProto_Type::TYPE_DOUBLE))
    }
    ...
    // Param is passed by value, moved
    pub fn set_field_type(&mut self, v: ::protobuf::ProtobufEnum<FieldDescriptorProto_Type>) {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ::protobuf::rt::read_proto2_enum_into(wire_type, is, &mut self.label)?
                },
                5 => {
                    ::protobuf::rt::read_proto2_enum_into(wire_type, is, &mut self.field_type)?
                },
                6 => {
...
impl ::protobuf::ProtoEnum for FieldDescriptorProto_Type {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::result::Result<FieldDescriptorProto_Type, i32> {
        match value {
            1 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_DOUBLE),
            2 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_FLOAT),
            3 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_INT64),
            4 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_UINT64),
            5 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_INT32),
            6 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_FIXED64),
            7 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_FIXED32),
            8 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_BOOL),
            9 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_STRING),
            10 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_GROUP),
            11 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_MESSAGE),
            12 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_BYTES),
            13 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_UINT32),
            14 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_ENUM),
            15 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_SFIXED32),
            16 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_SFIXED64),
            17 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_SINT32),
            18 => ::std::result::Result::Ok(FieldDescriptorProto_Type::TYPE_SINT64),
            i => ::std::result::Result::Err(i)
        }
    }
...
impl ::protobuf::ProtoEnum for FieldDescriptorProto_Label {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::result::Result<FieldDescriptorProto_Label, i32> {
        match value {
            1 => ::std::result::Result::Ok(FieldDescriptorProto_Label::LABEL_OPTIONAL),
            2 => ::std::result::Result::Ok(FieldDescriptorProto_Label::LABEL_REQUIRED),
            3 => ::std::result::Result::Ok(FieldDescriptorProto_Label::LABEL_REPEATED),
            i => ::std::result::Result::Err(i)
        }
    }
...
pub struct FileOptions {
    ...
    optimize_for: ::std::option::Option<::protobuf::ProtobufEnum<FileOptions_OptimizeMode>>,
...
impl FileOptions {
    ...
    pub fn get_optimize_for(&self) -> ::protobuf::ProtobufEnum<FileOptions_OptimizeMode> {
        self.optimize_for.unwrap_or(::protobuf::ProtobufEnum::from_enum(FileOptions_OptimizeMode::SPEED))
    }
    ...
    // Param is passed by value, moved
    pub fn set_optimize_for(&mut self, v: ::protobuf::ProtobufEnum<FileOptions_OptimizeMode>) {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                9 => {
                    ::protobuf::rt::read_proto2_enum_into(wire_type, is, &mut self.optimize_for)?
                },
                11 => {
...
impl ::protobuf::ProtoEnum for FileOptions_OptimizeMode {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::result::Result<FileOptions_OptimizeMode, i32> {
        match value {
            1 => ::std::result::Result::Ok(FileOptions_OptimizeMode::SPEED),
            2 => ::std::result::Result::Ok(FileOptions_OptimizeMode::CODE_SIZE),
            3 => ::std::result::Result::Ok(FileOptions_OptimizeMode::LITE_RUNTIME),
            i => ::std::result::Result::Err(i)
        }
    }
...
pub struct FieldOptions {
    // message fields
    ctype: ::std::option::Option<::protobuf::ProtobufEnum<FieldOptions_CType>>,
    packed: ::std::option::Option<bool>,
    jstype: ::std::option::Option<::protobuf::ProtobufEnum<FieldOptions_JSType>>,
...
impl FieldOptions {
    ...
    pub fn get_ctype(&self) -> ::protobuf::ProtobufEnum<FieldOptions_CType> {
        self.ctype.unwrap_or(::protobuf::ProtobufEnum::from_enum(FieldOptions_CType::STRING))
    }
    ...
    // Param is passed by value, moved
    pub fn set_ctype(&mut self, v: ::protobuf::ProtobufEnum<FieldOptions_CType>) {
    ...
    pub fn get_jstype(&self) -> ::protobuf::ProtobufEnum<FieldOptions_JSType> {
        self.jstype.unwrap_or(::protobuf::ProtobufEnum::from_enum(FieldOptions_JSType::JS_NORMAL))
    }
    ...
    // Param is passed by value, moved
    pub fn set_jstype(&mut self, v: ::protobuf::ProtobufEnum<FieldOptions_JSType>) {
...
impl ::protobuf::Message for FieldOptions {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_proto2_enum_into(wire_type, is, &mut self.ctype)?
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                ...
                6 => {
                    ::protobuf::rt::read_proto2_enum_into(wire_type, is, &mut self.jstype)?
                },
                5 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
...
impl ::protobuf::ProtoEnum for FieldOptions_CType {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::result::Result<FieldOptions_CType, i32> {
        match value {
            0 => ::std::result::Result::Ok(FieldOptions_CType::STRING),
            1 => ::std::result::Result::Ok(FieldOptions_CType::CORD),
            2 => ::std::result::Result::Ok(FieldOptions_CType::STRING_PIECE),
            i => ::std::result::Result::Err(i)
        }
    }
...
impl ::protobuf::ProtoEnum for FieldOptions_JSType {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::result::Result<FieldOptions_JSType, i32> {
        match value {
            0 => ::std::result::Result::Ok(FieldOptions_JSType::JS_NORMAL),
            1 => ::std::result::Result::Ok(FieldOptions_JSType::JS_STRING),
            2 => ::std::result::Result::Ok(FieldOptions_JSType::JS_NUMBER),
            i => ::std::result::Result::Err(i)
        }
    }
