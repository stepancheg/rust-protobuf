...
pub enum Value_oneof_kind {
    null_value(::protobuf::ProtobufEnum<NullValue>),
    number_value(f64),
...
impl Value {
    ...
    pub fn get_null_value(&self) -> ::protobuf::ProtobufEnum<NullValue> {
        match self.kind {
            ::std::option::Option::Some(Value_oneof_kind::null_value(v)) => v,
            _ => ::protobuf::ProtobufEnum::from_enum(NullValue::NULL_VALUE),
        }
    }
    ...
    // Param is passed by value, moved
    pub fn set_null_value(&mut self, v: ::protobuf::ProtobufEnum<NullValue>) {
...
impl ::protobuf::ProtoEnum for NullValue {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::result::Result<NullValue, i32> {
        match value {
            0 => ::std::result::Result::Ok(NullValue::NULL_VALUE),
