...
impl ::protobuf::Message for Duration {
    ...
    fn default_instance() -> &'static Duration {
        static instance: ::protobuf::rt::Lazy<Duration> = ::protobuf::rt::Lazy {
            lock: ::protobuf::rt::LAZY_ONCE_INIT,
            ptr: ::std::cell::UnsafeCell::new(0 as *const Duration),
        };
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\t\n\x02\x08\n\x12\x03'\0\"\n\x08\n\x01\x08\x12\x03(\0!\n\t\n\x02\x08$\
    \x12\x03(\0!\n\x92\x0c\n\x02\x04\0\x12\x04Z\0g\x01\x1a\x85\x0c\x20A\x20D\
    uration\x20represents\x20a\x20signed,\x20fixed-length\x20span\x20of\x20t\
    ime\x20represented\n\x20as\x20a\x20count\x20of\x20seconds\x20and\x20frac\
    tions\x20of\x20seconds\x20at\x20nanosecond\n\x20resolution.\x20It\x20is\
    \x20independent\x20of\x20any\x20calendar\x20and\x20concepts\x20like\x20\
    \"day\"\n\x20or\x20\"month\".\x20It\x20is\x20related\x20to\x20Timestamp\
    \x20in\x20that\x20the\x20difference\x20between\n\x20two\x20Timestamp\x20\
    values\x20is\x20a\x20Duration\x20and\x20it\x20can\x20be\x20added\x20or\
    \x20subtracted\n\x20from\x20a\x20Timestamp.\x20Range\x20is\x20approximat\
    ely\x20+-10,000\x20years.\n\n\x20Example\x201:\x20Compute\x20Duration\
    \x20from\x20two\x20Timestamps\x20in\x20pseudo\x20code.\n\n\x20\x20\x20\
    \x20\x20Timestamp\x20start\x20=\x20...;\n\x20\x20\x20\x20\x20Timestamp\
    \x20end\x20=\x20...;\n\x20\x20\x20\x20\x20Duration\x20duration\x20=\x20.\
    ..;\n\n\x20\x20\x20\x20\x20duration.seconds\x20=\x20end.seconds\x20-\x20\
    start.seconds;\n\x20\x20\x20\x20\x20duration.nanos\x20=\x20end.nanos\x20\
    -\x20start.nanos;\n\n\x20\x20\x20\x20\x20if\x20(duration.seconds\x20<\
    \x200\x20&&\x20duration.nanos\x20>\x200)\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20duration.seconds\x20+=\x201;\n\x20\x20\x20\x20\x20\x20\x20duration.n\
    anos\x20-=\x201000000000;\n\x20\x20\x20\x20\x20}\x20else\x20if\x20(durat\
    ions.seconds\x20>\x200\x20&&\x20duration.nanos\x20<\x200)\x20{\n\x20\x20\
    \x20\x20\x20\x20\x20duration.seconds\x20-=\x201;\n\x20\x20\x20\x20\x20\
    \x20\x20duration.nanos\x20+=\x201000000000;\n\x20\x20\x20\x20\x20}\n\n\
    \x20Example\x202:\x20Compute\x20Timestamp\x20from\x20Timestamp\x20+\x20D\
    uration\x20in\x20pseudo\x20code.\n\n\x20\x20\x20\x20\x20Timestamp\x20sta\
    rt\x20=\x20...;\n\x20\x20\x20\x20\x20Duration\x20duration\x20=\x20...;\n\
    \x20\x20\x20\x20\x20Timestamp\x20end\x20=\x20...;\n\n\x20\x20\x20\x20\
    \x20end.seconds\x20=\x20start.seconds\x20+\x20duration.seconds;\n\x20\
    \x20\x20\x20\x20end.nanos\x20=\x20start.nanos\x20+\x20duration.nanos;\n\
    \n\x20\x20\x20\x20\x20if\x20(end.nanos\x20<\x200)\x20{\n\x20\x20\x20\x20\
    \x20\x20\x20end.seconds\x20-=\x201;\n\x20\x20\x20\x20\x20\x20\x20end.nan\
    os\x20+=\x201000000000;\n\x20\x20\x20\x20\x20}\x20else\x20if\x20(end.nan\
    os\x20>=\x201000000000)\x20{\n\x20\x20\x20\x20\x20\x20\x20end.seconds\
    \x20+=\x201;\n\x20\x20\x20\x20\x20\x20\x20end.nanos\x20-=\x201000000000;\
    \n\x20\x20\x20\x20\x20}\n\n\x20Example\x203:\x20Compute\x20Duration\x20f\
    rom\x20datetime.timedelta\x20in\x20Python.\n\n\x20\x20\x20\x20\x20td\x20\
    =\x20datetime.timedelta(days=3,\x20minutes=10)\n\x20\x20\x20\x20\x20dura\
    tion\x20=\x20Duration()\n\x20\x20\x20\x20\x20duration.FromTimedelta(td)\
    \n\n\n\n\n\n\x03\x04\0\x01\x12\x03Z\x08\x10\np\n\x04\x04\0\x02\0\x12\x03\
    ^\x02\x14\x1ac\x20Signed\x20seconds\x20of\x20the\x20span\x20of\x20time.\
    \x20Must\x20be\x20from\x20-315,576,000,000\n\x20to\x20+315,576,000,000\
    \x20inclusive.\n\n\r\n\x05\x04\0\x02\0\x04\x12\x04^\x02Z\x12\n\x0c\n\x05\
    \x04\0\x02\0\x05\x12\x03^\x02\x07\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03^\
    \x08\x0f\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03^\x12\x13\n\x83\x03\n\x04\
    \x04\0\x02\x01\x12\x03f\x02\x12\x1a\xf5\x02\x20Signed\x20fractions\x20of\
    \x20a\x20second\x20at\x20nanosecond\x20resolution\x20of\x20the\x20span\n\
    \x20of\x20time.\x20Durations\x20less\x20than\x20one\x20second\x20are\x20\
    represented\x20with\x20a\x200\n\x20`seconds`\x20field\x20and\x20a\x20pos\
    itive\x20or\x20negative\x20`nanos`\x20field.\x20For\x20durations\n\x20of\
    \x20one\x20second\x20or\x20more,\x20a\x20non-zero\x20value\x20for\x20the\
    \x20`nanos`\x20field\x20must\x20be\n\x20of\x20the\x20same\x20sign\x20as\
    \x20the\x20`seconds`\x20field.\x20Must\x20be\x20from\x20-999,999,999\n\
