...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\x03GPB\xaa\x02\x1eGoogle.Protobuf.WellKnownTypesJ\xda#\n\x06\x12\
    ...
    \n\x02\x08\n\x12\x03'\0\"\n\x08\n\x01\x08\x12\x03(\0!\n\t\n\x02\x08$\x12\
    \x03(\0!\n\x9e\x10\n\x02\x04\0\x12\x04f\0s\x01\x1a\x91\x10\x20A\x20Durat\
    ...
    -10,000\x20years.\n\n\x20#\x20Examples\n\n\x20Example\x201:\x20Compute\
    \x20Duration\x20from\x20two\x20Timestamps\x20in\x20pseudo\x20code.\n\n\
    \x20\x20\x20\x20\x20Timestamp\x20start\x20=\x20...;\n\x20\x20\x20\x20\
    \x20Timestamp\x20end\x20=\x20...;\n\x20\x20\x20\x20\x20Duration\x20durat\
    ion\x20=\x20...;\n\n\x20\x20\x20\x20\x20duration.seconds\x20=\x20end.sec\
    onds\x20-\x20start.seconds;\n\x20\x20\x20\x20\x20duration.nanos\x20=\x20\
    end.nanos\x20-\x20start.nanos;\n\n\x20\x20\x20\x20\x20if\x20(duration.se\
    conds\x20<\x200\x20&&\x20duration.nanos\x20>\x200)\x20{\n\x20\x20\x20\
    \x20\x20\x20\x20duration.seconds\x20+=\x201;\n\x20\x20\x20\x20\x20\x20\
    \x20duration.nanos\x20-=\x201000000000;\n\x20\x20\x20\x20\x20}\x20else\
    \x20if\x20(duration.seconds\x20>\x200\x20&&\x20duration.nanos\x20<\x200)\
    \x20{\n\x20\x20\x20\x20\x20\x20\x20duration.seconds\x20-=\x201;\n\x20\
    \x20\x20\x20\x20\x20\x20duration.nanos\x20+=\x201000000000;\n\x20\x20\
    \x20\x20\x20}\n\n\x20Example\x202:\x20Compute\x20Timestamp\x20from\x20Ti\
    mestamp\x20+\x20Duration\x20in\x20pseudo\x20code.\n\n\x20\x20\x20\x20\
    \x20Timestamp\x20start\x20=\x20...;\n\x20\x20\x20\x20\x20Duration\x20dur\
    ation\x20=\x20...;\n\x20\x20\x20\x20\x20Timestamp\x20end\x20=\x20...;\n\
    \n\x20\x20\x20\x20\x20end.seconds\x20=\x20start.seconds\x20+\x20duration\
    .seconds;\n\x20\x20\x20\x20\x20end.nanos\x20=\x20start.nanos\x20+\x20dur\
    ation.nanos;\n\n\x20\x20\x20\x20\x20if\x20(end.nanos\x20<\x200)\x20{\n\
    \x20\x20\x20\x20\x20\x20\x20end.seconds\x20-=\x201;\n\x20\x20\x20\x20\
    \x20\x20\x20end.nanos\x20+=\x201000000000;\n\x20\x20\x20\x20\x20}\x20els\
    e\x20if\x20(end.nanos\x20>=\x201000000000)\x20{\n\x20\x20\x20\x20\x20\
    \x20\x20end.seconds\x20+=\x201;\n\x20\x20\x20\x20\x20\x20\x20end.nanos\
    \x20-=\x201000000000;\n\x20\x20\x20\x20\x20}\n\n\x20Example\x203:\x20Com\
    pute\x20Duration\x20from\x20datetime.timedelta\x20in\x20Python.\n\n\x20\
    \x20\x20\x20\x20td\x20=\x20datetime.timedelta(days=3,\x20minutes=10)\n\
    \x20\x20\x20\x20\x20duration\x20=\x20Duration()\n\x20\x20\x20\x20\x20dur\
    ation.FromTimedelta(td)\n\n\x20#\x20JSON\x20Mapping\n\n\x20In\x20JSON\
    \x20format,\x20the\x20Duration\x20type\x20is\x20encoded\x20as\x20a\x20st\
    ring\x20rather\x20than\x20an\n\x20object,\x20where\x20the\x20string\x20e\
    nds\x20in\x20the\x20suffix\x20\"s\"\x20(indicating\x20seconds)\x20and\n\
    \x20is\x20preceded\x20by\x20the\x20number\x20of\x20seconds,\x20with\x20n\
    anoseconds\x20expressed\x20as\n\x20fractional\x20seconds.\x20For\x20exam\
    ple,\x203\x20seconds\x20with\x200\x20nanoseconds\x20should\x20be\n\x20en\
    coded\x20in\x20JSON\x20format\x20as\x20\"3s\",\x20while\x203\x20seconds\
    \x20and\x201\x20nanosecond\x20should\n\x20be\x20expressed\x20in\x20JSON\
    \x20format\x20as\x20\"3.000000001s\",\x20and\x203\x20seconds\x20and\x201\
    \n\x20microsecond\x20should\x20be\x20expressed\x20in\x20JSON\x20format\
    \x20as\x20\"3.000001s\".\n\n\n\n\n\n\x03\x04\0\x01\x12\x03f\x08\x10\n\
    \xdc\x01\n\x04\x04\0\x02\0\x12\x03j\x02\x14\x1a\xce\x01\x20Signed\x20sec\
    onds\x20of\x20the\x20span\x20of\x20time.\x20Must\x20be\x20from\x20-315,5\
    76,000,000\n\x20to\x20+315,576,000,000\x20inclusive.\x20Note:\x20these\
    \x20bounds\x20are\x20computed\x20from:\n\x2060\x20sec/min\x20*\x2060\x20\
    min/hr\x20*\x2024\x20hr/day\x20*\x20365.25\x20days/year\x20*\x2010000\
    \x20years\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03j\x02\x07\n\x0c\n\x05\x04\
    \0\x02\0\x01\x12\x03j\x08\x0f\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03j\x12\
    \x13\n\x83\x03\n\x04\x04\0\x02\x01\x12\x03r\x02\x12\x1a\xf5\x02\x20Signe\
    d\x20fractions\x20of\x20a\x20second\x20at\x20nanosecond\x20resolution\
    \x20of\x20the\x20span\n\x20of\x20time.\x20Durations\x20less\x20than\x20o\
    ne\x20second\x20are\x20represented\x20with\x20a\x200\n\x20`seconds`\x20f\
    ield\x20and\x20a\x20positive\x20or\x20negative\x20`nanos`\x20field.\x20F\
    ...
    \x04\0\x02\x01\x05\x12\x03r\x02\x07\n\x0c\n\x05\x04\0\x02\x01\x01\x12\
